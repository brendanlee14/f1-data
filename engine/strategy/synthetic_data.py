...
RACES_2026 = [
    ...
    {"key": "emilia_romagna", "name": "Emilia Romagna GP",  "circuit": "Imola",        "round":  7, "laps": 63, "base_time": 78.0},
    ...
    {"key": "canada",         "name": "Canadian GP",        "circuit": "Montreal",     "round": 10, "laps": 70, "base_time": 75.5},
    ...
    {"key": "singapore",      "name": "Singapore GP",       "circuit": "Marina Bay",   "round": 16, "laps": 62, "base_time": 95.0},
    {"key": "usa",            "name": "United States GP",   "circuit": "Austin",       "round": 17, "laps": 56, "base_time": 97.0},
    {"key": "mexico",         "name": "Mexico City GP",     "circuit": "Mexico City",  "round": 18, "laps": 71, "base_time": 78.5},
    {"key": "brazil",         "name": "São Paulo GP",       "circuit": "Interlagos",   "round": 19, "laps": 71, "base_time": 72.0},
    {"key": "las_vegas",      "name": "Las Vegas GP",       "circuit": "Las Vegas",    "round": 20, "laps": 50, "base_time": 96.0},
    {"key": "qatar",          "name": "Qatar GP",           "circuit": "Lusail",       "round": 21, "laps": 57, "base_time": 84.5},
    {"key": "abu_dhabi",      "name": "Abu Dhabi GP",       "circuit": "Yas Marina",   "round": 22, "laps": 58, "base_time": 88.0},
]
...
_CIRCUIT_PROFILES: dict = {
    ...
    "emilia_romagna": {"two_stop_pct": 0.25, "pool_1s": [("MEDIUM","HARD"),("SOFT","HARD"),("HARD","MEDIUM")],                         "pool_2s": [("SOFT","MEDIUM","HARD")]},
